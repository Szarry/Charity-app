...
<header class="header--form-page">
    <nav class="container container--70">
        ...
        <ul>
            ...
            <li><a href="<c:url value="/admin/adminList"/> " class="btn btn--without-border">Zarządzanie Użytkownikami</a></li>
            <li><a href="index.html#about-us" class="btn btn--without-border">O nas</a></li>
            <li><a href="<c:url value="/admin/institutionList"/> " class="btn btn--without-border">Fundacje i organizacje</a></li>
